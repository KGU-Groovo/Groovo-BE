...
public class RequestLoggingFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    CachedBodyRequestWrapper requestWrapper =
        shouldCacheRequestBody(request) ? new CachedBodyRequestWrapper(request) : null;
  ...
  private String formatBody(byte[] body, String characterEncoding, String contentType) {
    ...
    Charset charset =
        characterEncoding == null ? StandardCharsets.UTF_8 : Charset.forName(characterEncoding);
    String text = new String(body, charset).replace("\r", "\\r").replace("\n", "\\n");
